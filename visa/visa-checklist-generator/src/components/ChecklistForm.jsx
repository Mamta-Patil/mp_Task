...
//       <select name="visaType" onChange={handleChange} required className="w-full border p-2 rounded">
...
//       <select name="userType" onChange={handleChange} required className="w-full border p-2 rounded">
...
//       <select name="maritalStatus" onChange={handleChange} required className="w-full border p-2 rounded">
//         <option value="">Marital Status</option>
//         <option value="Single">Single</option>
//         <option value="Married">Married</option>
//       </select>

//       <select name="financial" onChange={handleChange} required className="w-full border p-2 rounded">
//         <option value="">Financial Docs</option>
//         <option value="Bank Statement">Bank Statement</option>
//         <option value="Salary Slips">Salary Slips</option>
//       </select>

//       <input type="text" name="travelHistory" onChange={handleChange} placeholder="Travel History (optional)" className="w-full border p-2 rounded" />
